...
typedef struct
{
  ...
  OS_ECB *BufferAccess;		/*!< Pointer for access to the buffer in FIFO */
  OS_ECB *SpaceAvailable;	/*!< Pointer for availability of space in FIFO */
  OS_ECB *ItemsAvailable;	/*!< Pointer for availability of bytes in FIFO */
} TFIFO;
